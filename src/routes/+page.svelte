...
<main bind:this={main}>
  <section aria-labelledby="identity-title">
    ...
    <div class="blur-behind">
      <p>
        We are the rocket engineering student team of Politecnico di Torino,
        entirely dedicated to the research, design, and construction of rocket
        engines and experimental rockets with scientific payload capability. We
        are a group of more than 85 undergraduate, graduate and doctoral
        engineering students with great plans for the future.
      </p>
      <div class="btns">
  ...
  <section aria-labelledby="spac">
    ...
    <div class="blur-behind">
      ...
      <p>
        The Team's first rocket, Cavour, was launched on Thursday June 22nd from
        the launchpad B2 from the Vertical Launch Area of Spaceport America, at
        9:20 local time. The launch was a success! The flight was nominal and
        the rocket was recovered in good conditions and it can be reused
      </p>

      <p>
        The Spaceport America Cup (SA Cup) is a competition for student rocketry
        teams from all over the world. With over 150 teams from colleges and
        universities in 24 countries from 6 continents, the SA Cup is the
        world's largest intercollegiate rocket engineering competition. At SA
        Cup, students launch solid, liquid, and hybrid rockets to target
        altitudes of 10,000 and 30,000 feet (3,000 and 9,100 m).
      </p>
      <p>
        PoliTo Rocket Team has competed with the <a href="/projects/Cavour"
          >Cavour rocket</a
        > in the 10 ft apogee AGL COTS category with a target apogee of around 3km.The
        Team ranked 13th in its category and 20th overall with 119 teams participating.
      </p>
    </div>
  </section>
    ...
    <div class="timeline">
      ...
      <div class="timeline__body">
        <Event year={2021} month={10} ch={45} title="The beginning"
          ...
          >, a group of friends started designing an experimental sounding
          rocket.</Event
        >
        <Event
          year={2022}
          ...
          >On June 7th 2022, Politecnico di Torino officially approved the Team,
          which started working on <a href="/projects/Cavour">Project Cavour</a
          >.</Event
        >
        <Event year={2023} month={1} ch={51} title="Start of Project Efesto"
          >After the first general recruitment, <a href="/projects/Efesto"
            >Project Efesto</a
          > was started to research and develop a Liquid Rocket Engine for the Team's
          rockets.</Event
        >
        <Event
          year={2023}
        ...
        <Event
          ...
          >With <a href="/projects/Cavour">Project Cavour</a>, we represented
          Politecnico and Italy as the first Italian team at the
          <a
            href="https://spaceportamericacup.com/"
            target="_blank"
            rel="noreferrer">Spaceport America Cup</a
        ...
        <Event
          ...
          >We will be the first team from Politecnico to compete with Project
          Cavour at the 2023 <a
            href="https://euroc.pt/"
            target="_blank"
  ...
  <section aria-labelledby="contact-title">
    ...
    <div class="blur-behind">
      <p>
        We are eager to get in touch with you! Whether you want to join us,
        become our partner, or simply know something more about us, feel free to
        write us an email: <a href="mailto:info@politorocketteam.it"
          >info@politorocketteam.it</a
        >
      </p>
      <p>
        We are also on Instagram, LinkedIn, and Twitter: just one direct message
        away.
      </p>
      <div class="socials">
        <a
