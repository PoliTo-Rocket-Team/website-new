...
<svelte:head>
    ...
    <meta
        name="description"
        content="The Mission and Vision of the PoliTo Rocket Team"
    />
</svelte:head>
...
<main>
    ...
    <div class="text-cols">
        <p>
            ...
            multiple missions to the Moon and Mars in the forthcoming years, the
            rate of innovation in space-related technologies is steadily rising.
            Italy, since the inception of the space age, has always had a
            leading role, initially acting as a valuable partner of the major
            world space actors and, over the years, establishing a space
            industry that covers the whole space supply chain, with excellent
            results in all application sectors, also thanks to the academic and
            research community and the support of the government and the Italian
            Space Agency.
        </p>
        <p>
            PoliTo Rocket Team’s mission is to contribute to Italy's space
            ...
            involved in missiles, rockets, and spacecraft. With both technical
            and non-technical roles available, there are numerous prospects for
            students of all backgrounds to develop their skills and passion for
            space exploration. In addition, the Team wants to provide an
            environment where students from different courses and levels of
            experience can undergo academic and personal growth.
        </p>
        <p>
