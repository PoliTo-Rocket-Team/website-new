...
<svelte:head>
    ...
    <meta
        name="description"
        content="List of all the members of the team, grouped by year"
    />
</svelte:head>
        ...
        <div class="cols">
            ...
            <ul class="no-list">
                <li class="member">
                    ...
                    <span class="desc"
                        >President<br />Chief Engineer - Project Cavour</span
                    >
                </li>
                <li class="member">
                    <div class="socials">
                    ...
                    <span class="desc"
                        >Chief Technologist & Head of Strategy</span
                    >
                </li>
                <li class="member">
                    <div class="socials">
            ...
            <ul class="no-list">
                ...
                <li class="member">
                    ...
                    <span class="desc"
                        >CAD & Additive Manufacturing Lead Engineer</span
                    >
                </li>
                <li class="member">
                    <div class="socials">
