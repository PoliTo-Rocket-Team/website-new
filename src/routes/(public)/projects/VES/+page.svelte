...
<section class="cols">
    <div>
        ...
        <p>
            ...
            Instead, it develops another rocket specifically designed for
    ...
    <div>
        ...
        <p>
            VES is a single-stage rocket equipped with a solid Commercial
            Off-The-Shelf (COTS) motor and the following technical
            characteristics:
        </p>
        <ul class="list">
