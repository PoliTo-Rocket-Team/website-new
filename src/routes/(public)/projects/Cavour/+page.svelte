<script lang="ts">
    ...
    const test = Object.values(
        import.meta.glob("/src/img/cavour/test/*.{jpg,png}", {
            as: "url",
            eager: true,
        })
    );
    const spac = Object.values(
        import.meta.glob("/src/img/cavour/spac23/*.{jpg,png}", {
            as: "url",
            eager: true,
        })
    );
...
<svelte:head>
    ...
    <meta
        name="description"
        content="Cavour is a single-stage, 2.25m long, solid propelled rocket, with a variable target altitude and mission profile. Discover all its characteristics here!"
    />
</svelte:head>
...
<section class="cols">
    ...
    <div>
        ...
        <p>
            ...
            internal diameter of 100mm (3.94in), with a variable target
            altitude.
        </p>
        <p>
            It is composed of two body tubes and a coupler, and of four
            compartments plus the nose cone. The structure is made of
            lightweight composite materials, and all its internal components are
            high-performance 3D-printed carbon-reinforced polymers. Starting
            from the bottom, the rocket’s compartments are:
        </p>
        <ul class="list">
            ...
            <li>
                Recovery bay, which contains the parachutes and the other
                recovery components;
            </li>
            <li>Nose cone.</li>
        </ul>
...
<section>
    <ul class="cards scrollable">
        ...
        <li class="card">
            ...
            <p>
                The Cavour Rocket structure design is modular, able to mount
                different motors, of different classes, lengths and diameters.
                Multiple versions of the rocket can be launched with different
                mission objectives, such as different apogee targets, payload
                launch and deployment, or system testing.
            </p>
        </li>
        <li class="card">
            <h2 class="smudge">Reusable</h2>
            <p>
                Using a drogue chute and a main parachute, the rocket is
                designed to land without inflicting any damage to its airframe
                or to the environment. This allows the rocket to perform
                multiple launches without inflicting any damage to its airframe
                or to the environment, so that the rocket is capable of being
                flown again without any major repair after just some refueling.
            </p>
        </li>
    </ul>
</section>
...
<section>
    ...
    <Launch name="Test Launch" date="2023-04-29" images={test}>
        <p>
            On Saturday, April 29th, our Cavour rocket was successfully launched
            for the first time from a launch site in Bavaria, Germany.
        </p>
        <p>
            ...
            maximum boost acceleration of 9.79G.
        </p>
        <p>
            ...
            landed at around 1.2km from the launch site and was found in perfect
            condition with all airframe components intact: it is now ready to be
            reused.
        </p>
    </Launch>
    <Launch name="Spaceport America Cup" date="2023-06-22" images={spac}>
        <p>
            ...
            Spaceport America, the world's first commercial spaceport located in
            the Jornada del Muerto desert, approximately 90km from Las Cruces.
        </p>
        <p>
            The launch was a success, and the rocket reached an apogee of
            3142.8m AGL, with a maximum velocity of around 295.4 m/s and a
            maximum boost acceleration of 17.3G. The apogee was very close to
            the target apogee (3048m) and to the simulated one. The flight
            proceeded under nominal conditions, except for an early deployment
            of the main parachute. This minor malfunction in the recovery
            subsystem simply drifted the rocket away and did not compromise the
            integrity of the rocket in any way, as it can be reused for a new
            launch.
        </p>
        <p>
            Despite having only one year of experience and being at the first
            participation in a competition, the Team ranked 20th overall out of
            the 119 participating universities and 13th in the 10k ft apogee AGL
            with COTS propulsion category.
        </p>
        <p>
            Project Cavour won the Dr. Gil Moore Award for Innovation, which
            recognises a team whose project includes one or more genuinely
            “novel” or “inventive” features. Project Cavour won this award
